...
excluded_resources_instructions: |
  Игнорируй любые результаты поиска и ссылки, ведущие на ресурсы из списка excluded_resources.
  Не переходи на эти сайты и не собирай с них цены.
